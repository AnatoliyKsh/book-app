...
import CountBooks from "../components/BooksPage/CountBooks";
import BooksBtn from "../components/BooksPage/BooksBtn";
...
const Books = () => {
  ...
  if (!query) {
    return <h1 className="text-center">What are you looking for?</h1>;
  }
